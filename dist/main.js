...
/* harmony import */ var ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ng-multiselect-dropdown */ "./node_modules/ng-multiselect-dropdown/fesm5/ng-multiselect-dropdown.js");
...
var HomeComponent = /** @class */ (function () {
    ...
    Object.defineProperty(HomeComponent.prototype, "matPaginator", {
        set: function (mp) {
            this.paginator = mp;
    ...
    HomeComponent.prototype.setDataSourceAttributes = function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.items = data.map(function (item) { return new _ngx_gallery_core__WEBPACK_IMPORTED_MODULE_10__["ImageItem"]({ src: item.srcUrl, thumb: item.previewUrl }); });
        ...
        this.filteredOptions = this.myControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(""), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (value) { return (typeof value === "string" ? value : value.name); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (name) { return (name ? _this._filter(name) : _this.ELEMENT_DATA.slice()); }));
    ...
    HomeComponent.prototype.removeSelectedRows = function () {
        var _this = this;
        this.selection1.selected.forEach(function (item) {
            var index = _this.data.findIndex(function (d) { return d === item; });
            console.log(_this.data.findIndex(function (d) { return d === item; }));
            _this.dataSource1.data.splice(index, 1);
            _this.dataSource1 = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](_this.dataSource1.data);
        });
        this.selection1 = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_3__["SelectionModel"](true, []);
    };
    HomeComponent.prototype.deleteTicket = function (rowid) {
    ...
    /////////////////// funciones generales //////////////////////////////////
    HomeComponent.prototype.ShowDiv = function (divVal) {
        this.currDiv = divVal;
    };
    HomeComponent.prototype.ShowPdiv = function (divVal) {
        this.currPdiv = divVal;
    };
    HomeComponent.prototype.ShowSdiv = function (divVal) {
        this.currSdiv = divVal;
    };
    HomeComponent.prototype.toggle = function () {
        this.show = !this.show;
    };
    HomeComponent.prototype.open_modal = function (content) {
        this.modalService.open(content);
    };
    HomeComponent.prototype.open_modal_time = function (content) {
        var _this = this;
        setTimeout(function () {
    ...
    HomeComponent.prototype.basicLightboxExample = function () {
        this.gallery.ref().load(this.items);
    };
    HomeComponent.prototype.withCustomGalleryConfig = function () {
    ...
    HomeComponent.prototype.changeClass = function (event) {
        var _this = this;
        if (this.charge == true) {
            setTimeout(function () {
    ...
    HomeComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    HomeComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected()
            ? this.selection.clear()
            : this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    HomeComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
    ...
    HomeComponent.prototype._filter = function (name) {
        ...
        return this.ELEMENT_DATA.filter(function (option) { return option.name.toLowerCase().indexOf(filterValue) === 0; });
    };
    Object.defineProperty(HomeComponent.prototype, "piezas", {
        ///////////////// funcion paginador tabla paso 4 ///////////////////////////
        get: function () {
            return PIEZAS.map(function (piezas, i) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: i + 1 }, piezas)); }).slice((this.page - 1) * this.pageSize, (this.page - 1) * this.pageSize + this.pageSize);
        },
        enumerable: true,
        configurable: true
    });
    HomeComponent.prototype.setRegion = function () {
    ...
    HomeComponent.prototype.setCity = function () {
    ...
    HomeComponent.prototype.setAutoshop = function () {
    ...
    HomeComponent.prototype.setAutoshoptype = function () {
    ...
    HomeComponent.prototype.setAutoshopc = function () {
    ...
    HomeComponent.prototype.remove = function (index) {
